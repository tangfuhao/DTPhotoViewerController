Pod::Spec.new do |s|
  s.name             = "DTPhotoViewerController2"
  s.version          = "3.1.1"
...
DESC
  s.homepage         = "https://github.com/tangfuhao/DTPhotoViewerController"
  s.license          = 'MIT'
  s.author           = { "Tung Vo" => "tung98.dn@gmail.com" }
  s.source           = { :git => "git@github.com:tangfuhao/DTPhotoViewerController.git", :tag => s.version.to_s }
